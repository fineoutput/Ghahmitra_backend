...
Route::middleware('partnerapi.auth')->prefix('partner')->group(function () {
  ...
  Route::get('/profile', [PartnerController::class, 'getProfile']);
    ...
    Route::post('/accept-orders', [OrderController::class, 'acceptOrder']);
    Route::post('/reject-orders', [OrderController::class, 'rejectOrder']);
...
Route::middleware('customer.auth')->prefix('customer')->group(function () {
 ...
 Route::post('reschedule-order', [CartController::class, 'reschedule']);
 Route::get('orders', [CartController::class, 'ordersList']);
 Route::post('orders-details', [CartController::class, 'ordersdetails']);
