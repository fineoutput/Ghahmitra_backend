...
<head>
    ...
    <style>
        ...
        .address-picker-header .back-btn {
            background: none;
            border: none;
            font-size: 20px;
            cursor: pointer;
...
<body data-services-route="{{ route('services') }}">
          ...
          <input type="text" class="form-control border-start-0" placeholder="Search for 'Kitchen cleaning'">
                ...
                <div class="d-none d-lg-flex align-items-center gap-3">
                    ...
                    <div class="dropdown d-inline-block">
                        <a class="d-flex align-items-center text-dark text-decoration-none" href="#"
                            id="testProfileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg rounded-4 raaz"
                            aria-labelledby="testProfileDropdown" style="min-width:280px; border:none;">
                            <!-- Header Section -->
                ...
                <span style="font-size:0.95rem;">Payment History</span>
                            ...
                            <a href="{{ route('customer.logout') }}"
                                class="dropdown-item rounded-2 px-3 py-2 text-danger text-decoration-none"
                                style="transition:all 0.2s;display:flex;align-items:center;gap:0.75rem;">
                    ...
                    @if (Auth::guard('customer')->check())
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg rounded-4"
                                aria-labelledby="profileDropdown" style="min-width:280px; border:none;">
                                <!-- Header Section -->
                                <div class="mb-3 pb-3 border-bottom">
                                    <h6 class="fw-bold mb-1" style="font-size:0.95rem;">
                                        {{ Auth::guard('customer')->user()->name ?? 'User' }}</h6>
                                    <small
                                        class="text-muted d-block">{{ Auth::guard('customer')->user()->mobile_no ?? 'No mobile number provided' }}</small>
                                </div>
                    ...
                    @else
                        <a href="#" class="text-dark">
                            <i class="fa-regular fa-user fs-5" data-bs-toggle="modal"
            ...
            @if (request()->routeIs('/'))
                <div class="d-lg-none mt-3">
                    <div class="mobile-topbar-row">
                        <div class="mobile-location small text-muted" onclick="openAddressPicker()"
                        ...
                        <div class="mobile-cart-btn">
                            <a href="{{ route('cart') }}" class="btn btn-light rounded-circle"
                                style="width:42px;height:42px;display:inline-flex;align-items:center;justify-content:center;">
    ...
    <div class="address-picker-modal" id="addressPickerModal">
        <div class="address-picker-header">
            ...
            <input type="text" class="address-search-input"
                placeholder="Search for your location/society/apartment" id="addressSearch">
        </div>
            ...
            <div class="address-section">
                ...
                <div class="address-item" onclick="selectAddress(this)">
                    ...
                    <div class="address-item-content">
                        ...
                        <div class="address-item-detail">19, New Sanganer Rd, Kalyanpuri Colony, Sodala, Jaipur,
                            Rajasthan 302019, India</div>
                    </div>
                </div>
                ...
                <div class="address-item" onclick="selectAddress(this)">
                    ...
                    <div class="address-item-content">
                        <div class="address-item-name">Home</div>
                        <div class="address-item-detail">19, Kalawala, Chokhi Dhani, Sukhdeopura Nohara, Jaipur,
                            Shyosinghpura at Kallawala, Rajasthan 302029, ...</div>
                    </div>
                </div>
            ...
            <div class="address-section">
                ...
                <div class="address-item" onclick="selectAddress(this)">
                    ...
                    <div class="address-item-content">
                        ...
                        <div class="address-item-detail">New Sanganer Road, Kalyanpuri Colony, Sodala, Jaipur,
                            Rajasthan, India</div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content border-0 rounded-0 h-100">
                ...
                <div class="modal-body py-0">
                    <div class="p-4">
                        <!-- Header Section -->
                        <div class="mb-3 pb-3 border-bottom">
                            <h6 class="fw-bold mb-1" style="font-size:0.95rem;">{{ auth()->user()->name ?? 'Guest' }}
                            </h6>
                        ...
                        @else
                            <button class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#loginModal"
                                data-bs-dismiss="modal">Sign in / Sign up</button>
                        @endauth
                    </div>
                </div>
            </div>
    ...
    <nav class="bottom-nav d-lg-none" aria-label="Mobile navigation">
        <div class="bottom-nav-inner container d-flex justify-content-between">
            ...
            <a href="{{ route('services') }}" style="text-decoration: none;"
                class="bottom-nav-item text-center active">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 rounded-4 p-4 position-relative">
                ...
                <div id="phoneSection">
                    ...
                    <button id="continueBtn" class="btn btn-secondary w-100 rounded-3" disabled>
                        Continue
                    </button>
