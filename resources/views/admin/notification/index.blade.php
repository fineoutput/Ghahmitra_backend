    ...
    <div class="page-content-wrapper">
      <div class="row">
        ...
        @endif
              ...
              <div class="row">
                <div class="col-md-10">
                  <h4 class="mt-0 header-title">View Notifications List</h4>
                </div>
                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('notifications.create')}}" role="button" style="margin-left: 20px;"> Add Notifications</a></div>
              </div>
            ...
            <tbody>
                @foreach($notification as $key => $Services)
                    <tr>
                        <td>{{ $key+1 }}</td>
