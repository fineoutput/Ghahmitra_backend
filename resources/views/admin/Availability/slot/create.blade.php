                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                           ...
                           <form action="{{ route('slot.store',$thservices->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                {{-- <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label>Day <span style="color:red">*</span></label>
                                        <input type="date" class="form-control" name="day" value="{{ old('day') }}" required>
                                        @error('day') <div style="color:red">{{ $message }}</div> @enderror
                                    </div> --}}

                                    <input type="hidden" name="day_id" value="{{$thservices->id ?? ''}}">
