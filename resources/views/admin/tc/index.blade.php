    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="page-title-box">
          <h4 class="page-title">View T & C</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);">T & C</a></li>
    ...
    <div class="page-content-wrapper">
      <div class="row">
        ...
        @endif
              ...
              <div class="row">
                <div class="col-md-10">
                  <h4 class="mt-0 header-title">View T & C List</h4>
                </div>
                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('tc.create')}}" role="button" style="margin-left: 20px;"> Add T & C</a></div>
              </div>
