                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                          ...
                          <form action="{{ isset($ServicesSe) ? route('services2.update',       $ServicesSe->id) : route('services2.store') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control"
                                        name="name"
                                        value="{{ old('name', $ServicesSe->name ?? '') }}"
                                        required>
                                    @error('name')
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <select name="services_id" class="form-control" required>
                                        ...
                                        @foreach ($services as $srv)
                                            <option value="{{ $srv->id }}"
                                                {{ old('service_id', $ServicesSe->services_id ?? '') == $srv->id ? 'selected' : '' }}>
                                                {{ $srv->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <input type="file" class="form-control" name="image"
                                        {{ isset($ServicesSe) ? '' : 'required' }}>

                                    @error('image')
                                        <div style="color:red">{{ $message }}</div>
                                    @enderror

                                    @if(isset($ServicesSe) && $ServicesSe->image)
                                        <div class="mt-2">
                                            <img src="{{ asset($ServicesSe->image) }}" height="70">
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <textarea id="description" name="description" class="form-control" rows="4">{{ old('description', $ServicesSe->description ?? '') }}</textarea>
                                    @error('description')
                                        <div style="color:red">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-danger">
                                    {{ isset($ServicesSe) ? 'Update' : 'Submit' }}
                                </button>
                            </div>
                        </form>
